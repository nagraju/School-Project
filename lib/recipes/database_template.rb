...
# Category::    Capistrano
# Package::     Database
# Author::      Simone Carletti <weppos@weppos.net> (slightly modified by Jonas Grimfelt)
# Copyright::   2007-2009 The Authors
# License::     MIT License
# Link::        http://www.simonecarletti.com/
# Source::      http://gist.github.com/2769
# Article::     http://www.simonecarletti.com/blog/2009/06/capistrano-and-database-yml/
#
# == Requirements
#
...
# to ask for a database password instead of hard coding it into the template.
#
# === Password prompt
#
...
Capistrano::Configuration.instance.load do
  ...
  namespace :db do
    ...
    DESC
    task :symlink, :roles => :db, :except => {:no_release => true} do
      # Addition: Delete the config file if any.
